...
2. git fetch origin temporal-contrastive && git checkout -f temporal-contrastive && git pull
...
7. cp records/track_10min_16mb/2026-04-22_SP8192_3LayerRecur_ParResid_QK525_TemporalContrast/* /workspace/parameter-golf/
